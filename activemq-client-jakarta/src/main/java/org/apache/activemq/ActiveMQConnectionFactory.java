...
public class ActiveMQConnectionFactory extends JNDIBaseStorable implements ConnectionFactory, QueueConnectionFactory, TopicConnectionFactory, StatsCapable, Cloneable {
    ...
    public JMSContext createContext() {
        throw new UnsupportedOperationException("createContext() is unsupported in transitional client");
    }

    @Override
    public JMSContext createContext(String userName, String password) {
        throw new UnsupportedOperationException("createContext(String,String) is unsupported in transitional client");

    }

    @Override
    public JMSContext createContext(String userName, String password, int sessionMode) {
        throw new UnsupportedOperationException("createContext(String,String,int) is unsupported in transitional client");
    }

    @Override
    public JMSContext createContext(int sessionMode) {
        throw new UnsupportedOperationException("createContext(int) is unsupported in transitional client");
    }
}
