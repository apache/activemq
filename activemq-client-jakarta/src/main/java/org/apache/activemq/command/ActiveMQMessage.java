...
public class ActiveMQMessage extends Message implements org.apache.activemq.Message, ScheduledMessage {
    ...
    public void setJMSDeliveryTime(long deliveryTime) throws JMSException {
        throw new UnsupportedOperationException("setJMSDeliveryTime(long) is unsupported in transitional client");
    }

    @Override
    public <T> T getBody(Class<T> c) throws JMSException {
        throw new UnsupportedOperationException("getBody(Class<T>) is unsupported in transitional client");
    }

    @Override
    public boolean isBodyAssignableTo(Class c) throws JMSException {
        throw new UnsupportedOperationException("isBodyAssignableTo(Class) is unsupported in transitional client");
    }
}
