...
public class MKahaDBLRUKCacheConfigTest extends TestCase {

    private static final Logger LOG = LoggerFactory.getLogger(MKahaDBLRUKCacheConfigTest.class);
    ...
    public void testBrokerConfig() throws Exception {
        ...
        broker = createBroker("org/apache/activemq/store/mKahaDBLRUK.xml");
        LOG.info("Success");
