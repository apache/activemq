...
/**
 * Kerberos transport build on top of SslTransport and RFC2712.
 * Uses Kerberos authentication and KDC's key exchange to encrypt communication.
 */
public class Krb5OverSslTransport extends SslTransport {
    ...
    /**
     * Authentication with Kerberos and returns subject to be used for further communication encryption
     *
     * @param location
     *
