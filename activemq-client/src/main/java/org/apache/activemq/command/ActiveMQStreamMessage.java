...
public class ActiveMQStreamMessage extends ActiveMQMessage implements StreamMessage {
    ...
    public boolean readBoolean() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Boolean.parseBoolean(this.dataIn.readUTF());
            }
    ...
    public byte readByte() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Byte.parseByte(this.dataIn.readUTF());
            }
            if (type == MarshallingSupport.NULL) {
                this.dataIn.reset();
    ...
    public short readShort() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Short.parseShort(this.dataIn.readUTF());
            }
            if (type == MarshallingSupport.NULL) {
                this.dataIn.reset();
    ...
    public int readInt() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Integer.parseInt(this.dataIn.readUTF());
            }
            if (type == MarshallingSupport.NULL) {
                this.dataIn.reset();
    ...
    public long readLong() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Long.parseLong(this.dataIn.readUTF());
            }
            if (type == MarshallingSupport.NULL) {
                this.dataIn.reset();
    ...
    public float readFloat() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Float.parseFloat(this.dataIn.readUTF());
            }
            if (type == MarshallingSupport.NULL) {
                this.dataIn.reset();
    ...
    public double readDouble() throws JMSException {
        ...
        try {
            ...
            if (type == MarshallingSupport.STRING_TYPE) {
                return Double.parseDouble(this.dataIn.readUTF());
            }
            if (type == MarshallingSupport.NULL) {
                this.dataIn.reset();
