 ...
 */
public abstract class ProducerConsumerScenarioSupport extends ScenarioSupport {

    protected ProducerAgent producer;
    protected ConsumerAgent consumer;
    protected MessageList messageList;

    public ProducerConsumerScenarioSupport(ProducerAgent producer, ConsumerAgent consumer, MessageList messageList) {
