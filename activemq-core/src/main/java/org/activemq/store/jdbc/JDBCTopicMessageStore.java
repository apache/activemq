...
public class JDBCTopicMessageStore extends JDBCMessageStore implements TopicMessageStore {
    ...
    /**
     * @see org.activemq.store.TopicMessageStore#storeSubsciption(org.activemq.service.SubscriptionInfo,
     *      boolean)
     */
    ...
    /**
     * @see org.activemq.store.TopicMessageStore#lookupSubscription(String,
     *      String)
     */
