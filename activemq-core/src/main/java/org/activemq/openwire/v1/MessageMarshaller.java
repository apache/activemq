...
public abstract class MessageMarshaller extends BaseCommandMarshaller {
    ...
    public void unmarshal(OpenWireFormat wireFormat, Object o, DataInputStream dataIn, BooleanStream bs) throws IOException {
        ...
        info.setProducerId((org.activemq.command.ProducerId) unmarsalCachedObject(wireFormat, dataIn, bs));
        ...
        info.setOriginalDestination((org.activemq.command.ActiveMQDestination) unmarsalCachedObject(wireFormat, dataIn, bs));
        info.setMessageId((org.activemq.command.MessageId) unmarsalNestedObject(wireFormat, dataIn, bs));
        info.setOriginalTransactionId((org.activemq.command.TransactionId) unmarsalCachedObject(wireFormat, dataIn, bs));
        ...
        info.setReplyTo((org.activemq.command.ActiveMQDestination) unmarsalNestedObject(wireFormat, dataIn, bs));
        ...
        info.setDataStructure((org.activemq.command.DataStructure) unmarsalNestedObject(wireFormat, dataIn, bs));
        info.setTargetConsumerId((org.activemq.command.ConsumerId) unmarsalCachedObject(wireFormat, dataIn, bs));
        info.setCompressed(bs.readBoolean());
        info.setRedeliveryCounter(dataIn.readInt());
        
		        if( bs.readBoolean() ) {
		            short size = dataIn.readShort();
		            org.activemq.command.BrokerId value[] = new org.activemq.command.BrokerId[size];
		            for( int i=0; i < size; i++ ) {
		                value[i] = (org.activemq.command.BrokerId)unmarsalNestedObject(wireFormat,dataIn, bs);
		            }
