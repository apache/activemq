    ...
    public void unmarshal(OpenWireFormat wireFormat, Object o, DataInputStream dataIn, BooleanStream bs) throws IOException {
        ...
        DataArrayResponse info = (DataArrayResponse)o;
		        ...
		        if( bs.readBoolean() ) {
		            ...
		            org.activemq.command.DataStructure value[] = new org.activemq.command.DataStructure[size];
		            for( int i=0; i < size; i++ ) {
		                value[i] = (org.activemq.command.DataStructure)unmarsalNestedObject(wireFormat,dataIn, bs);
		            }
		            info.setData(value);
		        } else {
		            info.setData(null);
