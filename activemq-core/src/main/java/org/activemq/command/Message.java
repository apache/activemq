...
abstract public class Message extends BaseCommand implements MarshallAware, MessageReference {
    ...
    private transient org.activemq.broker.region.Destination regionDestination;
    ...
    public org.activemq.broker.region.Destination getRegionDestination() {
        return regionDestination;
    }

    public void setRegionDestination(org.activemq.broker.region.Destination destination) {
