...
/**
 * Small burn test moves sends a moderate amount of messages through the broker, to 
 * checking to make sure that the broker does not lock up after a while of sustained
 * messaging.
 * 
 * @version $Revision$
 */
...
//        return BrokerFactory.createBroker(new URI("xbean:org/activemq/broker/store/loadtester.xml"));
    }
