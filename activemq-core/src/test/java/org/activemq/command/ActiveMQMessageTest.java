...
public class ActiveMQMessageTest extends TestCase {
    ...
    public void testConvertProperties() throws Exception {
        org.activemq.command.Message msg = new org.activemq.command.Message() {
            public org.activemq.command.Message copy() {
                return null;
            }
    ...
    public void testObjectPropertyConversion() throws JMSException {
        ...
        try {
            ((org.activemq.command.Message)msg).setProperty(propertyName, obj); //bypass object check
        } catch (IOException e) {
        }
        try {
