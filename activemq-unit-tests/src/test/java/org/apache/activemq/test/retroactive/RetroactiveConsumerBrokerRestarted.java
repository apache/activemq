...
public class RetroactiveConsumerBrokerRestarted extends TestCase {

    private static final Logger log = LoggerFactory.getLogger(RetroactiveConsumerBrokerRestarted.class);
