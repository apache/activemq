...
/**
 * to be compliant with JDBC spec; officially commit is not supposed to be called on
 * a connection that uses autocommit.The oracle v12 driver does a check for
 * autocommitSpecCompliance and it causes issues
 * <p/>
 * To test; wrap the datasource used by the broker and check for autocommit before delegating
 * to real datasource. If commit is called on connection with autocommit, wrapper throws a
 * SQLException.
 */

public class JDBCStoreAutoCommitTest {

    public static final String BROKER_NAME = "AutoCommitTest";
    ...
    private BrokerService createBrokerService() throws IOException {
        ...
        javax.sql.DataSource wrappedDataSource =
                new TestDataSource(embeddedDataSource);
    ...
    /*
    ===============
    Need some wrapping classes to throw exception if commit called when autocommit is enabled
    ================
     */
    ...
    private class TestDataSource implements javax.sql.DataSource {
        ...
        public Connection getConnection() throws SQLException {
            ...
            Connection autoCommitCheckConnection =
                    new AutoCommitCheckConnection(realDataSource.getConnection());
        ...
        public Connection getConnection(String username, String password) throws SQLException {
            ...
            Connection autoCommitCheckConnection =
                    new AutoCommitCheckConnection(realDataSource.getConnection(username, password));
    ...
    private class AutoCommitCheckConnection implements Connection {
        ...
        /*
         verify commit is not called on an autocommit connection
         */
        @Override
        ...
        // Just plumping for wrapper. Might have been better to do a Dynamic Proxy here.
