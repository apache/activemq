 ...
 * 
 */
public class KahaStoreQueueFastTest extends SimpleQueueTest {

    @Override
    protected void setUp() throws Exception {
        super.setUp();
        this.clientURI = "tcp://localhost:61616?wireFormat.cacheEnabled=true&wireFormat.tightEncodingEnabled=true&jms.useAsyncSend=true&jms.producerWindowSize=1024000&wireFormat.maxInactivityDuration=0";
    }
