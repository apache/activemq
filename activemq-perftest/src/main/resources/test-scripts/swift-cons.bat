...
set SPI_CLASS=org.apache.activemq.tool.spi.SwiftMQPojoSPI
set EXT_DIR="c:/swiftmq.jar"
set BROKER_URL_PARAM="factory.brokerUrl=smqp://localhost:4001"
set PROVIDER=SWIFT
...
CALL mvn activemq-perf:consumer -DsysTest.propsConfigFile=%CONFIG_FILE% -DsysTest.spiClass=%SPI_CLASS% -Dfactory.extDir=%EXT_DIR% -DsysTest.reportName=%REPORT_NAME% -D%BROKER_URL_PARAM%
