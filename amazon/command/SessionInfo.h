...
namespace ActiveMQ {
  namespace Command {
    ...
    {
      private:
        boost::shared_ptr<const SessionId> sessionId_;
      ...
      public:
        ...
        virtual boost::shared_ptr<const SessionId> getSessionId() const;
        virtual void setSessionId(const boost::shared_ptr<SessionId>& sessionId);
    };
  }
}
