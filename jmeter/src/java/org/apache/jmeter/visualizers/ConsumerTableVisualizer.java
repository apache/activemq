...
/**
 * A tableVisualizer that can display Consumer Output
 */
public class ConsumerTableVisualizer extends AbstractVisualizer implements Clearable {
    ...
    private final long INSECONDS = 60;
    private final long MINUTE = SECOND * INSECONDS;


    /**
     * Constructor for the TableVisualizer object.
     */
    public ConsumerTableVisualizer() {
    ...
    public String getLabelResource() {
        ...
        return "view_cons_results_in_table";
    }
    ...
    protected void timerLoop() {
        ...
        long timeInSec = 0;
        int msgCounter = 0;
        long duration = Consumer.duration;
        long ramp_up = Consumer.ramp_up;
        ...
        while (difInMins < duration) {
            ...
            long processed = Consumer.resetCount();
